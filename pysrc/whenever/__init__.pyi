...
@type_check_only
class _OrderWithNoneMixin:
    MIN: ClassVar[Self]
    MAX: ClassVar[Self]
    def __lt__(self, other: Self | None, /) -> bool: ...
    def __le__(self, other: Self | None, /) -> bool: ...
...
@final
class Date(_ISOMixin, _OrderWithNoneMixin):
    @overload
...
@final
class PlainDateTime(
    _PyDateTimeMixin, _ISOMixin, _OrderWithNoneMixin, _LocalTime
):
    @overload
    def __init__(
        self,
